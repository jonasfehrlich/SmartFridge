...
/** Cooking recipe. Lecture 2.1.7: ArrayList as typed collection. */
public class Recipe implements Serializable {
    ...
    public Recipe(String name, String description, List<String> ingredients,
        ...
        this.preparationTime = preparationTime; this.source = source;
    }
    ...
    @Override
    public String toString() { return name + " (approx. " + preparationTime + " | " + source + ")"; }
}
