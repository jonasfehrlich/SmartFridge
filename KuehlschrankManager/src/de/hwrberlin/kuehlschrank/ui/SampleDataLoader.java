...
public class SampleDataLoader {
    public static void load(FridgeManager manager) {
        ...
        manager.addProduct(new FridgeProduct("Yoghurt", ProductCategory.DAIRY, 2.0, "pcs", LocalDate.now().plusDays(4), 1.0, "Top shelf"));
        manager.addProduct(new FridgeProduct("Cheese", ProductCategory.DAIRY, 150.0, "grams", LocalDate.now().plusDays(7), 100.0, "Top shelf"));
        manager.addProduct(new FridgeProduct("Bell pepper", ProductCategory.FRUITS_VEGETABLES, 2.0, "pcs", LocalDate.now().plusDays(3), 1.0, "Vegetable drawer"));
        manager.addProduct(new FridgeProduct("Carrots", ProductCategory.FRUITS_VEGETABLES, 300.0, "grams", LocalDate.now().plusDays(5), 200.0, "Vegetable drawer"));
